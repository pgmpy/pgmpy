...
class LinearGaussianBayesianNetwork(DAG):
    ...
    def log_likelihood(self, data: pd.DataFrame) -> float:
        ...
        ... )
        >>> float(round(model.log_likelihood(df), 10))
        -855.0646932773
        """
    ...
    def get_random(
        ...
        >>> sorted(model.nodes())
        ['X_0', 'X_1', 'X_2', 'X_3', 'X_4']
        >>> sorted(model.edges()) # doctest: +SKIP
        [('X_0', 'X_1'), ('X_1', 'X_2'), ('X_1', 'X_3'), ('X_1', 'X_4')]
        >>> # The structure generated by get_random() is not guaranteed to be stable even with a fixed seed
        >>> model.cpds # doctest: +SKIP
        [<LinearGaussianCPD: P(X_0) = N(0.305; 1.04) at 0x...,
        <LinearGaussianCPD: P(X_2 | X_0, X_1) = N(0.678*X_0 + -0.586*X_1 + 0.244; 0.909) at 0x...,
        <LinearGaussianCPD: P(X_3 | X_0, X_1, X_2) = N(0.102*X_0 + 0.327*X_1 + 1.136*X_2 + 1.446; 0.824) at 0x...,
        <LinearGaussianCPD: P(X_1) = N(-0.458; 0.623) at 0x...,
        <LinearGaussianCPD: P(X_4 | X_1) = N(1.218*X_1 + -0.503; 0.271) at 0x...]
        """
