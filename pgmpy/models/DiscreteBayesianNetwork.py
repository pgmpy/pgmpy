...
class DiscreteBayesianNetwork(DAG):
    ...
    **Shortcuts:**
    ...
    def add_edge(self, u: Any, v: Any, w: Optional[Any] = None, **kwargs) -> None:
        """
    ...
    def remove_nodes_from(self, nodes: Union[List, Set]) -> None:
        """
    ...
    ) -> Union[TabularCPD, List[TabularCPD], None]:
        """
    ...
    def remove_cpds(self, *cpds: Union[TabularCPD, Any]) -> None:
        """
    ...
    @property
    def states(self) -> Dict[Any, List[Any]]:
        """
    ...
    def to_junction_tree(
        self,
    ) -> (
        nx.Graph
    ):  # The return type should be nx.Graph as per the base class/implementation
        """
    ...
    def get_state_probability(self, states: dict) -> float:
        """
    ...
    def get_markov_blanket(self, node: Any) -> List:
        """
    ...
    def get_random(
        ...
        n_states: Optional[Union[int, dict]] = None,
        latents: bool = False,
        seed: Optional[int] = None,
