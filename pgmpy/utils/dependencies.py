    ...
    *packages,
    ...
    for package in packages:
        ...
        if pkg_env_version is None:
            if obj is None and msg is None:
                msg = (
                    ...
                    f"base pgmpy installation. Please run: `pip install {package}` to "
                ...
                msg = (
                    ...
                    f"pgmpy installation. Please run: `pip install {package}` to "
                    f"install the {package} package. "
                    f"To install all soft dependencies, run: `pip install "
                    f"pgmpy[all]`"
                )
        ...
        if package_version_req != SpecifierSet(""):
            ...
            if obj is not None:
                msg = msg + (
                    f"This version requirement is not one by pgmpy, but specific "
