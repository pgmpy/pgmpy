...
@pytest.fixture
def em_data():
    model1 = get_example_model("cancer")
...
class TestEM:
    def test_get_parameters(self, em_data):
        model1, data1, model2, data2 = em_data
        # All observed
        est = EM(model1, data1)
    ...
    def test_get_parameters_smoothing_k2(self, em_data):
        model1, data1, model2, data2 = em_data
        # All observed
        est = EM(model1, data1)
    ...
    def test_get_parameters_smoothing_bdeu(self, em_data):
        model1, data1, model2, data2 = em_data
        # All observed
        est = EM(model1, data1)
        cpds = est.get_parameters(
    ...
    def test_get_parameters_initial_cpds(self, em_data):
        model1, data1, model2, data2 = em_data
    ...
    def test_em_init_missing_data_handling(self, em_data):
        model1, data1, model2, data2 = em_data
        df = pd.DataFrame(
    ...
    def test_get_parameters_random_init_cpds(self, em_data):
        model1, data1, model2, data2 = em_data
        est = EM(model1, data1)
        cpds = est.get_parameters(
    ...
    def test_get_parameters_uniform_init_cpds(self, em_data):
        model1, data1, model2, data2 = em_data
        est = EM(model1, data1)
    ...
    def test_get_parameters_node_specific_ess_bdeu(self, em_data):
        model1, data1, model2, data2 = em_data
    ...
    def test_get_parameters_ess_dict_vs_scalar(self, em_data):
        model1, data1, model2, data2 = em_data
