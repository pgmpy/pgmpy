...
class TestLogLikelihoodUnified(unittest.TestCase):
    ...
    def test_frequency_vs_cpd_scoring(self):
        ...
        freq_result = freq_score.score(self.model)
    ...
    def test_consistency_with_old_implementations(self):
        ...
        new_score = LogLikelihoodScore(self.data, use_cpd=True).score(self.model)

        old_score = BayesianModelProbability(self.model).score(self.data)
