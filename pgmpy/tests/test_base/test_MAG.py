...
def test_invisible_edge_due_to_latent():
    m = MAG(
        ebunch=[("X", "Y", "-", ">"), ("X", "L", "-", ">"), ("Y", "L", "-", ">")],
        latents={"L"},
    )
...
def test_lower_manipulation_fixture(mag):
...
def test_lower_manipulation_adds_bidirected():
    m = MAG(ebunch=[("X", "L", "-", ">"), ("Y", "L", "-", ">")], latents={"L"})
...
def test_upper_manipulation_fixture(mag):
...
def test_manipulations_keep_original(mag):
