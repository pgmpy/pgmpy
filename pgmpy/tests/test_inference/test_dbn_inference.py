...
def dbn_inference_2():
    ...
    return dbn_inference_2


class TestDBNInference:
    def test_forward_inf_single_variable(self, dbn_inference_1):
        query_result = dbn_inference_1.forward_inference([("X", 0)])
        np_test.assert_array_almost_equal(
            query_result[("X", 0)].values, np.array([0.84, 0.16])
        )

    def test_forward_inf_multiple_variable(self, dbn_inference_1):
    ...
    def test_forward_inf_single_variable_with_evidence(
        self, dbn_inference_1, dbn_inference_2
    ):
        query_result = dbn_inference_1.forward_inference(
            [("Z", 1)], {("Y", 0): 0, ("Y", 1): 0}
        )
        np_test.assert_array_almost_equal(
            query_result[("Z", 1)].values, np.array([0.95080214, 0.04919786])
        )
        query_result = dbn_inference_2.forward_inference(
    ...
    def test_forward_inf_multiple_variable_with_evidence(self, dbn_inference_1):
        query_result = dbn_inference_1.forward_inference(
            [("Z", 1), ("X", 1)], {("Y", 0): 0, ("Y", 1): 0}
        )
        np_test.assert_array_almost_equal(
    ...
    def test_backward_inf_single_variable(self, dbn_inference_2):
        query_result = dbn_inference_2.backward_inference([("Y", 0)])
        np_test.assert_array_almost_equal(
            query_result[("Y", 0)].values, np.array([0.225, 0.775])
        )

    def test_backward_inf_multiple_variables(self, dbn_inference_2):
    ...
    def test_backward_inf_single_variable_with_evidence(
        self, dbn_inference_1, dbn_inference_2
    ):
        query_result = dbn_inference_2.backward_inference(
        ...
        query_result = dbn_inference_1.backward_inference(
    ...
    def test_backward_inf_multiple_variables_with_evidence(self, dbn_inference_2):
        query_result = dbn_inference_2.backward_inference(
