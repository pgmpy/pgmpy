...
class TestLGCPD(unittest.TestCase):
    def test_class_init(self):
        ...
        cpd2 = LinearGaussianCPD('y', 0.67, 2, ['x1', 'x2', 'x3'],
                                 [1, 4.56, 8])
        ...
        self.assertRaises(ValueError, LinearGaussianCPD, 'x', 1, 2,
                          ['a', 'b', 'c'], [1, 2])
        self.assertRaises(ValueError, LinearGaussianCPD, 'x', 1, 2,
                          ['a', 'b'], [1, 2, 3])
    ...
    def test_str(self):
        ...
        self.assertEqual(cpd2.__str__(), "P(y| x1, x2, x3) = N(1.0*x1_mu + 4.56*x2_mu + 8.0*x3_mu; 0.67)")
