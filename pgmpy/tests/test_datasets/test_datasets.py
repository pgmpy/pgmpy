...
def test_load_angrist_krueger_cps_dataset():
    dataset = load_dataset("angrist_krueger_cps")
    assert dataset.name == "angrist_krueger_cps"
    assert dataset.data.shape == (13993, 58)
    assert dataset.tags["n_samples"] == 13993
    assert dataset.tags["n_variables"] == 58
    assert isinstance(dataset.data, pd.DataFrame)

    categorical_vars = [
        "lot1b50", "lot2b50", "lot3b50", "lot1b51", "lot2b51", "lot3b51", "lot1b52", "lot2b52",
        "lot3b52", "lot1b53", "lot2b53", "lot3b53", "midatl", "eastnth", "westnth", "black", "other",
        "city", "balsmsa", "spsepres", "yr81", "yr82", "yr83", "yr84", "yr85", "yob45", "yob46",
        "yob47", "yob48", "yob49", "yob50", "yob51", "yob52", "yob53", "educ", "veteran", "ceiling",
        "coarse1", "coarse2", "coarse3", "lott1", "lott2", "lott3", "lott4", "lott5", "lott6",
        "lott7", "lott8", "lott9", "lott10", "lott11", "lott12", "lott13", "recode"
    ]
    for var in categorical_vars:
        assert isinstance(dataset.data[var].dtype, pd.CategoricalDtype)
