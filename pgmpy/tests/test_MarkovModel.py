...
class TestBaseModelCreation(unittest.TestCase):
    def setUp(self):
        self.graph = mm.MarkovModel()

    def test_class_init_without_data(self):
        self.assertIsInstance(self.graph, mm.UndirectedGraph)
    ...
    def test_add_node_nonstring(self):
        self.assertRaises(TypeError, self.graph.add_node, 1)
    ...
    def test_add_nodes_from_non_string(self):
        self.assertRaises(TypeError, self.graph.add_nodes_from, [1, 2, 3, 4])
    ...
    def test_add_edge_nonstring(self):
        self.assertRaises(TypeError, self.graph.add_edge, 1, 2)
    ...
    def test_add_edges_from_nonstring(self):
        self.assertRaises(TypeError, self.graph.add_edges_from, [(1, 2), (2, 3)])
    ...
    def test_number_of_neighbors(self):
        self.graph.add_edges_from([('a', 'b'), ('b', 'c')])
        self.assertEqual(self.graph.number_of_neighbours('b'), 2)
...
class TestMarkovModelMethods(unittest.TestCase):
    def setUp(self):
        self.graph = mm.MarkovModel([('a', 'd'), ('b', 'd'),
                                     ('d', 'e'), ('b', 'c')])
