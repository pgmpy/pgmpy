...
class TestIndependenceAssertion(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertion1 = Independencies.IndependentceAssertion(['U', 'V'], ['Y', 'Z'], ['A', 'B'])
    ...
    def test_init_exceptions(self):
        self.assertRaises(Exceptions.Required, Independencies.IndependenceAssertion, event2=['U'], event3='V')
        self.assertRaises(Exceptions.Required, Independencies.IndependenceAssertion, event2=['U'])
        self.assertRaises(Exceptions.Required, Independencies.IndependenceAssertion, event3=['Z'])
        self.assertRaises(Exceptions.Required, Independencies.IndependenceAssertion, event1=['U'])
        self.assertRaises(Exceptions.Required, Independencies.IndependenceAssertion, event1=['U'], event3=['Z'])
...
class TestIndependencies(unittest.TestCase, IndependenciesTestCase):
    ...
    def test_init(self):
        ...
        self.assertImapEqual(self.Independencies2.Independencies, {Independencies.IndependenceAssertion('X', 'Y'),
    ...
    def test_get_Independencies(self):
        self.Independencies1.add_assertions(['X', 'Y', 'Z'])
        self.assertImapEqual(self.Independencies1.Independencies, {Independencies.IndependenceAssertion('X', 'Y', 'Z')})
