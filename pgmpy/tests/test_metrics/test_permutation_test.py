...
class TestPermutationBasedFalsificationTest(unittest.TestCase):
    ...
    def test_basic_functionality(self):
        ...
        expected_keys = [
            'falsifiable', 'falsified', 'p_value_falsifiable', 
            'p_value_falsified', 'lmc_violations', 'n_permutations', 'same_mec_count'
        ]
    ...
    def test_with_return_summary(self):
        ...
        result = permutation_based_falsification_test(
            self.simple_model, self.simple_data, 
            n_permutations=10, return_summary=True, show_progress=False
        )
        ...
        expected_summary_keys = [
            'permutation_violations', 'significance_level', 'ci_test',
            'mean_permutation_violations', 'std_permutation_violations',
            'min_permutation_violations', 'max_permutation_violations'
        ]
    ...
    def test_wrong_model_detection(self):
        ...
        wrong_model = DiscreteBayesianNetwork([("Z", "Y"), ("Y", "X")])  # Completely reversed
    ...
    def test_continuous_data_support(self):
        ...
        result = permutation_based_falsification_test(
            self.simple_model, self.continuous_data, 
            ci_test="pearsonr", n_permutations=10, show_progress=False
        )
    ...
    def test_input_validation(self):
        ...
        with self.assertRaises(ValueError):
            permutation_based_falsification_test(
                self.simple_model, self.simple_data, 
                ci_test="unsupported_test", show_progress=False
            )
