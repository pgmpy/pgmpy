...
class BaseEstimator(object):
    ...
    def state_counts(
        ...
        >>> estimator.state_counts(variable='A')
            count
        A
        a1      2
        a2      1
        >>> estimator.state_counts(variable='C', parents=['A', 'B'])
        A    a1        a2
        B    b1   b2   b1   b2
        C
        c1  1.0  1.0  0.0  0.0
        c2  0.0  0.0  1.0  0.0
        >>> estimator.state_counts(variable='C', parents=['A'])
        A    a1   a2
        C
        c1  2.0  0.0
        c2  0.0  1.0
...
class ParameterEstimator(BaseEstimator):
    ...
    def state_counts(self, variable, weighted=False, **kwargs):
        ...
        a1      2
        a2      1
        >>> estimator.state_counts(variable='C')
        A    a1        a2
        B    b1   b2   b1   b2
        C
        c1  1.0  1.0  0.0  0.0
