...
class MaximumLikelihoodEstimator(ParameterEstimator):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        warnings.warn(
            "`pgmpy.estimators.MaximumLikelihoodEstimator` is deprecated and will be removed in a future "
            "release. Use `pgmpy.parameter_estimator.MaximumLikelihoodEstimator` instead.",
            FutureWarning,
            stacklevel=2,
        )
