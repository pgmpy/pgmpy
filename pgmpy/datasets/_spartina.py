...
class Spartina(_BaseDataset):
    ...
    def load_dataframe(cls) -> pd.DataFrame:
        """Custom parser for spartina covariance matrix format with space-separated variables."""
        ...
        variable_names = lines[1].split(
            " "
        )  # Second line is variable names (space-separated)
